            ...
            foreach($catalog as $catalogItem){ 
                if($catalogItem['catalog_actif'] == 0){ ?>
                    ...
                    <div class="cardDisable catalogId<?=$catalogItem["id_catalogue"]?>">
                        ...
                        ?>
                        <button class="like <?= $isActive ? 'activeTrue' : 'activeFalse'; ?> likeCollor<?= $catalogItem["id_catalogue"] ?>" id="<?= $catalogItem["id_catalogue"] ?> <?= $isActive ? 'activeTrue' : 'activeFalse'; ?>" onclick="like(<?= $catalogItem["id_catalogue"] ?>)">
                ...
                <?php }else if($catalogItem['origin'] == "catalog" && $catalogItem['brouillon'] == 0){ ?>
                    <div class="card catalogId<?=$catalogItem["id_catalogue"]?>">
                        ...
                        $urlName = str_replace(' ', '+', $catalogItem["nom"]);
                        ?>
                        <button class="like <?= $isActive ? 'activeTrue' : 'activeFalse'; ?> likeCollor<?= $catalogItem["id_catalogue"] ?>" id="<?= $catalogItem["id_catalogue"] ?> <? echo $isActive ? 'activeTrue' : 'activeFalse'; ?>" onclick="like(<?= $catalogItem["id_catalogue"] ?>)">
                            <span class="cataLike <?= $catalogItem["id_catalogue"] ?> likeId<?= $catalogItem["id_catalogue"] ?>" id="likeId<?= $catalogItem["id_catalogue"] ?>"><?= $catalogItem['likes'] ?></span>
                            <i class="fa-solid fa-heart"></i>
                        </button>
